                ...
                <tr key={cita.id}>
                  ...
                  <td>
                    <span className={`status-badge ${
                      ...
                      cita.estado === 'Pendiente' ? 'status-pending' :
                      'status-cancelled'
                    }`}>
                      {cita.estado}
                    </span>
                  ...
                  <td>
                    <div className="action-links">
                      <a href="#edit" className="link-edit">Editar</a>
                      <a href="#cancel" className="link-cancel">Cancelar</a>
                    </div>
                  </td>
                </tr>
              ))}
