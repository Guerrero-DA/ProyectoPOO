        ...
        <div className="reports-header">
          ...
          <button className="btn-generar-reporte">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 3H15C15.5523 3 16 3.44772 16 4V14C16 14.5523 15.5523 15 15 15H3C2.44772 15 2 14.5523 2 14V4C2 3.44772 2.44772 3 3 3Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          {reportes.map((reporte) => (
            <div key={reporte.idReporte} className="reporte-card">
              ...
              <button className="btn-descargar">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 12V3M9 12L6 9M9 12L12 9" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
