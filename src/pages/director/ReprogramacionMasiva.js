...
function ReprogramacionMasiva() {
  ...
  const handleToggleCita = (idCita) => {
    setSelectedCitas(prev =>
      prev.includes(idCita)
        ? prev.filter(id => id !== idCita)
        : [...prev, idCita]
    );
  };
                ...
                <div className="cita-row-right">
                  <div className="cita-icon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4 4C2.89543 4 2 4.89543 2 6V14C2 15.1046 2.89543 16 4 16H16C17.1046 16 18 15.1046 18 14V6C18 4.89543 17.1046 4 16 4H4Z" stroke="#999" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M14 2V6M6 2V6M2 10H18" stroke="#999" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  <div className="cita-fecha-hora">{cita.fecha} - {cita.hora}</div>
                </div>
              </div>
            ))}
          </div>
